...
console.log(sumDouble(12,34));
console.log(sumDouble(2,2));
console.log(sumDouble(9,9));
...
// Call it a few times and console.log the result, to make sure it is working
console.log(makes10(10,3));
console.log(makes10(7,3));
console.log(makes10(3,3));
...
// Declare your function here
/*var isParrotTalking = Math.random()*2;

if (isParrotTalking <= 1 ){
    return true;
}else{
    return false;
}
...
function parrotTrouble(hour){
    if(isParrotTalking == true && hour > 20){
        return true;
    }
    if(isParrotTalking == true && hour < 7){
        return true;
    }else{
        return false;
    }
...
// Call it a few times and console.log the result, to make sure it is working
// console.log(parrotTrouble(true,3));
